...
const Header = ({ onNewBinClick }) => {
  ...
  return (
    <>
      {isNavbarVisible ? (
        <div className='grid grid-cols-1 md:grid-cols-6 gap-3 bg-blue-50 w-full p-2 text-blue-300'>
          ...
          <div className='flex flex-col items-start h-full text-black'>
            ...
            <button className='border-blue-700 text-blue-950 rounded-md border-2 h-8 w-full mt-2'>
